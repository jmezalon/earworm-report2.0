...
Song.create!(title: "Start Over" , img_url: "https://images.genius.com/9ff72ecce321980c87eed95e7304bd5f.1000x1000x1.jpg", user_id: User.all.sample.id, genre_id: rap.id)
Song.create!(title: "Lots of Love", img_url: "https://www.musiconvinyl.com/fotos/3910_foto1_product_xl.jpg", user_id: User.all.sample.id, genre_id: rag.id)
Song.create!(title: "My boo", img_url: "https://i.ytimg.com/vi/t4z6M7Tbpk0/hqdefault.jpg", user_id: User.all.sample.id, genre_id: Genre.third.id)
Song.create!(title: "Middle Child", img_url: "https://studybreaks.com/wp-content/uploads/2019/02/j.cole2_.jpg" , user_id: User.all.sample.id, genre_id: rap.id)
Song.create!(title: "Pitit Deyo", img_url: "https://i1.sndcdn.com/artworks-000200587487-fcyyop-t500x500.jpg", user_id: User.all.sample.id, genre_id: k.id)
